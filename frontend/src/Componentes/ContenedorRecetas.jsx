...
function ContenedorRecetas({ recetas }) {
    return (
        <div className="contenedor-recetas p-1 m-2">
            {recetas.map((receta) => (
                <div key={receta.id} className="receta-card p-1">
                    <div className="corazon position-absolute z-3 m-2 p-1">
                    ...
                    <div className="row titulo">
                        <h2 className="col-10 m-0 p-2">{receta.nombre}</h2>
