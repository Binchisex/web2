...
const CrearReceta = () => {
    ...
    const agregarPaso = () => {
        setPasos([
            ...pasos,
            { paso: `Paso ${pasos.length + 1}`, descripcion: "" }  // Agregamos un paso vacío
        ]);
    };
    ...
    const handleCrearCategoria = () => {
        // Limitar a un máximo de 5 categorías
    ...
    const handlePublicar = () => {
        ...
        try {
            const response = fetch("http://localhost:3002/recetas/crear", {
                method: "POST",
                headers: {
            ...
            <div className="row contenedor-standar p-3">
                    ...
                    <div className="mt-3">
                        {ingredientes.map((ingrediente, index) => (
                            <div key={index} className="d-flex align-items-center mb-2">
                                ...
                                />
                                <button 
                                    className="btn-ingrediente ms-2" 
                ...
                <div className="col-9 p-3">
                    ...
                    <div className="p-3 pe-0">
                        <input type="text" className="input-standar" placeholder="Nombre de la receta"/>
                    </div>
                    <textarea 
                    ...
                    <div className="row justify-content-between align-items-center mt-3 d-flex">
                        ...
                        <div className="categoria-creada-container">
                            {categoriasNuevas.map((categoria, index) => (
                                <div key={index} className="categoria-creada mt-1 p-2">
